...
namespace TourAgency1._0.Migrations
{
    ...
    [Migration("20210131145654_DeleteServeClass2")]
    partial class DeleteServeClass2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TourAgency1.Models.ServeClass", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("servingClass")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Id");

                    b.HasIndex("servingClass")
                        .IsUnique();

                    b.ToTable("serveClass");
                });
            ...
            modelBuilder.Entity("TourAgency1.Models.AirLines", b =>
                {
                    ...
                    b.HasOne("TourAgency1.Models.ServeClass", "serveClass")
                        .WithMany("airLines")
                        .HasForeignKey("ServeClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
